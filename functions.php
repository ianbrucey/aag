...
-------------------------------------------------------------------------------------------------------
*/
function aag_script_enqueue() {
    wp_enqueue_style('include-bootstrap', 'https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.3.1/css/bootstrap.min.css');
    wp_enqueue_script('include-bootstrap', 'https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/4.3.1/js/bootstrap.min.js');
    wp_enqueue_script('include-jquery', 'https://cdnjs.cloudflare.com/ajax/libs/jquery/3.3.1/jquery.min.js');
...
add_action('wp_enqueue_scripts', 'aag_script_enqueue');
